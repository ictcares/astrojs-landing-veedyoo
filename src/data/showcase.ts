// Real documentaries produced end-to-end by Veedyoo (admin account),
// streamed from the CDN. Regenerate/extend via the app; keep meta honest —
// these are unedited outputs and the costs are the real credit charges.
export const showcase = [
  ...
  {
    title: "The Pigeon Post: 3,000 Years of Messages on Wings",
    meta: "ARCHIVAL HISTORY · PRODUCED FOR $1.44 · UNEDITED",
    video: "https://cdn.veedyoo.com/projects/cmrqx5jdp000301rvvvkkdnf5/renders/cmrqyg4pr000w01rv0dx9em54.mp4",
    poster: "https://cdn.veedyoo.com/projects/cmrqx5jdp000301rvvvkkdnf5/img/s02-imageUrl.png",
    duration: "PT2M28S",
    uploadDate: "2026-07-19"
  }
];
